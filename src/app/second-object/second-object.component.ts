...
@Component({
  selector: 'app-second-object',
  templateUrl: './second-object.component.html',
  styleUrls: ['./second-object.component.css']
})
export class SecondObjectComponent implements OnInit {
  ...
  sphere.rotation.z=30;
  sphere.modifier = rand;
  
  
  ///+/+/+/+/+/+/+/+/
  scene.add(sphere2);
  sphere2.position.x = -45;
  sphere2.position.y = -18;
  sphere2.position.z = -15;
          ...
          const lightSphere2 = new THREE.DirectionalLight(0xffffff, 0.6);
          lightSphere2.position.z = -1600;
          lightSphere2.position.x = 600;
          lightSphere2.position.y = 300;
  ...
  sphere.rotation.y=(sphere.position.y+mouseY*0.000425)*(-1);
  sphere.rotation.z=sphere.position.z+mouseX*0.000425;
